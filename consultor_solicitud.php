...
function enviar_mensaje(msj){	
  ...
  // Realizar peticion HTTP
  peticion_http.open('GET', 'php/enviar_contacto_solicitud.php?num=<?php echo $_GET['num']; ?>&usu=consultor&msj='+msj, true);
  peticion_http.send(null);
...
<div id="p1">
  ...
  <tr>
    ...
    <th width="190" scope="col"><a href="consultor.php"><img src="imagenes/boton_atras.png" width="130" height="50" class="i1" /></a></th>
  ...
  <tr>
    <th scope="col"><input name="usu" type="text" id="usu"  value="consultor" readonly="readonly" style="visibility:hidden" /></th>
    <th height="64" scope="col"><input name="button3" type="submit" class="boton" id="button3" value="Subir" />
      <input name="button4" type="button" class="boton_lista" id="button4" value="Lista de Documentos" onclick="location.href='consultor_documentos.php?num=<?php echo $num_solicitud; ?>'" /></th>
    <th scope="col">&nbsp;</th>
  </tr>
  </table>
</form>
