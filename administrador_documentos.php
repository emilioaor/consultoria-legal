...
<div id="principal2">
  ...
  <?php
    ...
    <th bgcolor="#006699" scope="col"><a href="php/eliminar_documento.php?num='.$num_solicitud.'&doc='.$documento.'&usu=administrador"><img src="imagenes/eliminar_documento.png" width="80" height="100" class="i2" /></a></th>
  </tr>';
  ...
  <tr>
    <th width="232" height="103" scope="col">&nbsp;</th>
    <th width="170" scope="col"><a href="administrador_solicitud.php?num=<?php echo $num_solicitud ?>"><img src="imagenes/boton_atras.png" width="130" height="50" class="i3" /></a></th>
    <th width="170" scope="col"><a href="index.html"><img src="imagenes/boton_cerrar_sesion.png" width="130" height="50" class="i4" /></a></th>
